 ...
 * The main public-facing homepage content for the live site.
 * Extracted from the original page.tsx to enable conditional rendering
 * based on site status (live, coming_soon, maintenance).
 */
