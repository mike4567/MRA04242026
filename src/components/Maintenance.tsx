 ...
 * Displays a full-screen "Maintenance" page when the site is under maintenance.
 * Features background image with semi-transparent overlay and admin access.
 * 
 * Content is loaded dynamically from icons/Maintenance.md
 */
...
export function Maintenance({ content }: MaintenanceProps) {
        ...
        <>
            ...
            <div className="fixed inset-0 w-full h-full overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: "url('/icons/Maintenance.png')",
                    }}
                />
